    ...
    PanelWindow {
        ...
        Item {
            ...
            WidgetCanvas {
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.screentime.enable && (Config.options.background.screenList.length === 0 || Config.options.background.screenList.includes(bgRoot.screen.name))
