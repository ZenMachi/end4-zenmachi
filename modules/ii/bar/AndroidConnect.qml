...
MouseArea {
    ...
    implicitWidth: vertical
        ...
        : Math.max((contentLoader.item ? contentLoader.item.implicitWidth : 0), Appearance.font.pixelSize.larger) + 8
    implicitHeight: vertical
        ? Math.max((contentLoader.item ? contentLoader.item.implicitHeight : 0), Appearance.font.pixelSize.larger)
